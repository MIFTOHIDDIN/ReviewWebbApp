...
import { Btn, Container, Content, Details, Footer, Image } from '../Review Card/style'
...
export const ReviewCard = ({ url, title }) => {
            ...
            <Container>
                ...
                <Content>
                    ...
                    <Footer>
                        ...
                        <Btn onClick={() => navigate('/home/reviews')}>Read full review</Btn>
                    </Footer>
                </Content>
